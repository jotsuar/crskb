<?php
App::uses('ProductsLock', 'Model');

/**
 * ProductsLock Test Case
 */
class ProductsLockTest extends CakeTestCase {
 ...
 */
	public function setUp() {
		parent::setUp();
		$this->ProductsLock = ClassRegistry::init('ProductsLock');
	}
