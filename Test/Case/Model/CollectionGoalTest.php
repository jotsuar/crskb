<?php
App::uses('CollectionGoal', 'Model');

/**
 * CollectionGoal Test Case
 */
class CollectionGoalTest extends CakeTestCase {
 ...
 */
	public function setUp() {
		parent::setUp();
		$this->CollectionGoal = ClassRegistry::init('CollectionGoal');
	}
