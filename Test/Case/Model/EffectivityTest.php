<?php
App::uses('Effectivity', 'Model');

/**
 * Effectivity Test Case
 */
class EffectivityTest extends CakeTestCase {
 ...
 */
	public function setUp() {
		parent::setUp();
		$this->Effectivity = ClassRegistry::init('Effectivity');
	}
