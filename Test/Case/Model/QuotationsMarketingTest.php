<?php
App::uses('QuotationsMarketing', 'Model');

/**
 * QuotationsMarketing Test Case
 */
class QuotationsMarketingTest extends CakeTestCase {
 ...
 */
	public function setUp() {
		parent::setUp();
		$this->QuotationsMarketing = ClassRegistry::init('QuotationsMarketing');
	}
 ...
 */
	public function tearDown() {
		unset($this->QuotationsMarketing);
