<?php
App::uses('BillProduct', 'Model');

/**
 * BillProduct Test Case
 */
class BillProductTest extends CakeTestCase {
 ...
 */
	public function setUp() {
		parent::setUp();
		$this->BillProduct = ClassRegistry::init('BillProduct');
	}
