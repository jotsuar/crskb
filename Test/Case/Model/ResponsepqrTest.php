<?php
App::uses('Responsepqr', 'Model');

/**
 * Responsepqr Test Case
 */
class ResponsepqrTest extends CakeTestCase {
 ...
 */
	public function setUp() {
		parent::setUp();
		$this->Responsepqr = ClassRegistry::init('Responsepqr');
	}
