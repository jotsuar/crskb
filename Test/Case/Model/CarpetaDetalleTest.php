<?php
App::uses('CarpetaDetalle', 'Model');

/**
 * CarpetaDetalle Test Case
 */
class CarpetaDetalleTest extends CakeTestCase {
 ...
 */
	public function setUp() {
		parent::setUp();
		$this->CarpetaDetalle = ClassRegistry::init('CarpetaDetalle');
	}
