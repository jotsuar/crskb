<?php
App::uses('SuggestedProduct', 'Model');

/**
 * SuggestedProduct Test Case
 */
class SuggestedProductTest extends CakeTestCase {
 ...
 */
	public function setUp() {
		parent::setUp();
		$this->SuggestedProduct = ClassRegistry::init('SuggestedProduct');
	}
