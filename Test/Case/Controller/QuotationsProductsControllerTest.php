<?php
App::uses('QuotationsProductsController', 'Controller');

/**
 * QuotationsProductsController Test Case
 */
class QuotationsProductsControllerTest extends ControllerTestCase {
