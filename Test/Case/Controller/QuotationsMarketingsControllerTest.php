<?php
App::uses('QuotationsMarketingsController', 'Controller');

/**
 * QuotationsMarketingsController Test Case
 */
class QuotationsMarketingsControllerTest extends ControllerTestCase {
