...
;(function ( $, window, document, undefined ) {
    ...
    ComboTree.prototype.createSourceItemHTML = function (sourceItem) {
        ...
        if (this.options.isMultiple)
            ...
            itemHtml += '<span data-id="' + sourceItem.id + '" id="liSelect'+sourceItem.id+'" data-selectable="' + isSelectable + '" class="comboTreeItemTitle ' + selectableClass + '">' + sourceItem.title + '</span>';
        }
    ...
    ComboTree.prototype.refreshInputVal = function () {
        ...
        if(this.options.selected.length>0){
            var idData = "span#liSelect"+this.options.selected[0];
            $("body").find(idData).addClass('activeSelect')
        }
