	<?php 
		...
		$flujoBloqueoData = isset($flujoBloqueoData) ? $flujoBloqueoData : null; $productInfo =  $this->Utilities->getQuantityBlock($producto,$flujoBloqueoData); 
	?>
						...
						<div class="row">
							...
							<div class="col-md-8 p-0">
								<div class="dataproductview2">
									<small class="text-success">Referencia: <?php echo $producto['part_number'] ?> / Marca: <?php echo isset($producto['brand']) ? $producto['brand'] : 'KEBCO' ?></small> 
									...
									<?php if (isset($inventario_wo) ): ?>
										...
										<?php endif ?>										
									<?php endif ?>
									<?php if ( isset($reserva) && isset($reserva["reservas"]) && !empty($reserva["reservas"]) && !is_null($reserva) ): ?>
