<div class="col-md-12">
	...
	<div class=" blockwhite spacebtn20">
		<div class="row ">
			<div class="col-md-12">
				<h2 class="titleviewer">Crear listas de distribución</h2>
			</div>
		</div>
	</div>
	...
	<div class=" blockwhite spacebtn20">
		<?php echo $this->Form->create('MailingList'); ?>
			<?php
				...
				echo $this->Form->input('numbers',["label" => "Números / Correos","required"]);
			?>
		<div class="form-control">
			<?php echo $this->Form->input('archivo',["label" => "Subir CSV","type" => "file","required" => false ]); ?>
		</div>
