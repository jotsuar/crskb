...
<html>
    ...
    <body>
        ...
        <form id="formid" method="post" action="https://www.pagoagil.net/onestep/">
            ...
            <input type="hidden" name="referencia" value="<?php echo ($qt_product."Z".$quotation_id) ?>" />
            <input type="hidden" name="fecha" value="" />
            <input type="hidden" name="hora" value="" />
            <input type="hidden" name="descripcion_pago" value="Pago del producto - <?php echo $datosProduct["Product"]["part_number"]  ?> | Cotización: <?php echo $datosQuation["Quotation"]["codigo"] ?>" />
            <input type="hidden" name="monto" value="<?php echo round($datosProduct['QuotationsProduct']['quantity'] *$datosProduct['QuotationsProduct']['price']*1.19,2) ?>" />
            <input type="hidden" name="monto_inicial" value="" />
            <input type="hidden" name="otros_valores" value="" />
            <input type="hidden" name="iva" value="<?php echo round($datosProduct['QuotationsProduct']['quantity'] *$datosProduct['QuotationsProduct']['price']*0.19,2) ?>" />
            <input type="hidden" name="iac" value="" />
            <input type="hidden" name="base_devolucion" value="<?php echo round($datosProduct['QuotationsProduct']['quantity'] *$datosProduct['QuotationsProduct']['price'],2) ?>" />
            ...
            <input type="hidden" name="url_ipn" value="<?php echo Router::url("/",true)."quotations/payments_ipn/"?><?php echo $this->Utilities->encryptString($qt_product."__".$quotation_id) ?>" />
