...
<?php echo $this->Form->create('Adress'); ?>
	...
	<?php
		...
		echo $this->Form->input('phone_two');
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('Adress.id')), array('confirm' => __('Are you sure you want to delete # %s?', $this->Form->value('Adress.id')))); ?></li>
