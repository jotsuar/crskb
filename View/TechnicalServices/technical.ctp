		...
		<div class="row">
			<nav class="navbar navbar-expand-lg navbar-light bg-filter">
				<div class="collapse navbar-collapse spacebt" id="navbarTogglerDemo01">
					<div class="col-md-12">
						<div class="row">
							<div class="col-md-4 back1 px-0 border-right">
								<div class="contentback1 ">
										<?php echo $this->Html->link('ÓRDENES EN PROCESO', array('action' => 'index'),array('class' => '')); ?>
			...
			<table cellpadding="0" cellspacing="0" class="myTableTechnicalServices table-striped table-bordered">
				<thead>
					<tr>
						...
						<th><?php echo $this->Paginator->sort('TechnicalService.date_end', 'F. fiinalizado'); ?></th>
						<th>Id Flujo</th>
						<th>Cotización</th>
						<th>Acciones</th>
					</tr>
