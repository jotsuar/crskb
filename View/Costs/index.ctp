<div class="costs index">
	...
	<tr>
			...
			<th><?php echo $this->Paginator->sort('purchase_price_usd'); ?></th>
	...
	<tr>
		...
		<td><?php echo h($cost['Cost']['purchase_price_usd']); ?>&nbsp;</td>
		<td>
		...
		<td class="actions">
			...
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $cost['Cost']['id']), array('confirm' => __('Are you sure you want to delete # %s?', $cost['Cost']['id']))); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</tbody>
