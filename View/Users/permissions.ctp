<?php echo $this->Form->create('User',array("id" => "userFormPermiso","type" => "file")); ?>
...
<div class="col-md-12">
	...
	<div class="form-group mt-2">
		<?php echo $this->Form->input('users',array('label' => false,"multiple","options" => $usuarios, "value" => $actuales, "style" => 'height: 200px;',"multiple" => true ));?>
	</div>
