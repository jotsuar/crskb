...
<?php echo $this->Form->create('ImportProduct'); ?>
	<fieldset>
		<legend><?php echo __('Edit Import Product'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('ImportProduct.id')), array('confirm' => __('Are you sure you want to delete # %s?', $this->Form->value('ImportProduct.id')))); ?></li>
