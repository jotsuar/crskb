	...
	<div class="col-md-12 p-0" id="cotizacionview">
		...
		<div class="blockwhite">
			...
			<div class="contentmargin">
				<h3>
					<?php echo $this->Utilities->explode_city($datosUsuario['User']['city'], "Colombia") .', '.$this->Utilities->date_castellano(date("Y-m-d H:i:s")); ?>
				</h3>
				<br>
				<p>Sr(a):</p>
				...
				<div class="productoscotizados">
					...
					<?php foreach ($datosProductos as $value): ?>
						...
						<div class="col-md-3 mt-4 valoresTRM" style="display: <?php echo AuthComponent::user("role") == "Gerente General" || AuthComponent::user("role") == "Asesor Comercial"  ? "block" : "none" ?>">
							...
							<div class="row">
								...
								<?php $margenValue = $value["QuotationsProduct"]["currency"] == "usd" ? $value["Category"]["margen"] : $value["Category"]["margen_wo"]?>
								...
								<div class="scrolldataprices">
									<div class="col-md-12 text-center fila1">
										<span><b>Categoría: </b> <?php echo $value["Category"]["name"] ?></span>
										<span>
					...
					<div class="notasImagenes">
						...
						<div class="totalcotiza mt-5 ">
							<?php if ($totalNoIva > 0): ?>
								<?php if ($datosQuation['Quotation']['total_visible'] && $iva == 1): ?>
							...
							<?php if ($totalNoIvaUSD > 0): ?>
								<?php if ($datosQuation['Quotation']['total_visible'] && $iva == 1): ?>
									...
									<div class="divprice">
										...
										<?php $ivaParts = explode(",", number_format(($totalIvaUSD * 0.19), "2",",",".")) ?>
										<?php $totalIvaParts = explode(",", number_format(($totalNoIvaUSD + ($totalIvaUSD * 0.19) ), "2",",",".")) ?>
										<div class="contentprice">
