...
<div class='form-group'>
	...
	<?php if (isset($this->request->query["id"])): ?>
		<?php echo $this->Form->input('Producto.number', array('class' => 'form-control border-input','label'=>false,'type'=>"hidden")); ?>
	<?php else: ?>
		<?php echo $this->Form->input('Producto.number', array('class' => 'form-control border-input','label'=>false,'type'=>"hidden", "value" => $number)); ?>		
	<?php endif ?>
</div>
...
<div class='form-group'>
	<?php echo $this->Form->input('Producto.iva', array('class' => 'form-control border-input','label'=>false,'div'=>false, "options" => ["1" => "SI", "0" => "NO"], "label" => "Producto cotizado con IVA")); ?>
</div>
