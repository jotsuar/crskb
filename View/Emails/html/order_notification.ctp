				...
				<table style="width: 600px; background-color:#ffffff; color:#111E2D; display:block; margin: 0 auto; border-collapse: collapse; font-family: Helvetica, Arial, Sans-Serif;">
					<tr align="center">
						...
						<td style="width:500px;">
							...
							<?php if ($type == "aprovee"): ?>
								<p style="color:#6f6f6f;">Desde el correo <b><?php echo $correoPrincipal ?></b> se aprobó la orden de pedido del flujo: <b><?php echo $flujo ?></b> </p>
							<?php else: ?>
								<p style="color:#6f6f6f;">Desde el correo <b><?php echo $correoPrincipal ?></b> se ha rechazado la orden de pedido del flujo: <b><?php echo $flujo ?></b></p>
							<?php endif ?>
