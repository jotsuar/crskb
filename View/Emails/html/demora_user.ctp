				...
				<table style="width: 600px; background-color:#ffffff; color:#111E2D; display:block; margin: 0 auto; border-collapse: collapse; font-family: Helvetica, Arial, Sans-Serif;">
					<tr align="center">
						...
						<td style="width:500px;">
							...
							<p align="justify">Desde el área de Logística de Kebco, te informamos que la importación a tu cargo cargo para el flujo de proceso <b><?php echo $flujo ?></b> , cuenta con una anomalía.</p>
