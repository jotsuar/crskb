				...
				<table style="width: 600px; background-color:#ffffff; color:#111E2D; display:block; margin: 0 auto; border-collapse: collapse; font-family: Helvetica, Arial, Sans-Serif;">
					<tr align="center">
						...
						<td style="width:500px;">
							...
							<p align="justify">
								Desde el área de <b>Servicio técnico de Kebco</b>, deseamos validar la continuidad del proceso de un equipo ingresado a nuestras instalaciones el día <b><?php echo date("Y-m-d",strtotime($servicio["created"])) ?></b> con el código de servicio <b><?php echo $servicio["code"] ?></b>.
							</p>
							<br>
							<p>El asesor te ha enviado el siguiente mensaje: <br>
								<div>
									<?php echo $mensaje ?>
								</div>
							</p>
