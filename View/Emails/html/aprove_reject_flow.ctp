				...
				<table style="width: 600px; background-color:#ffffff; color:#111E2D; display:block; margin: 0 auto; border-collapse: collapse; font-family: Helvetica, Arial, Sans-Serif;">
					<tr align="center">
						...
						<td style="width:500px;">
							...
							<?php if ($reject == "1"): ?>
								<p style="color:#6f6f6f;">El asesor <b><?php echo $asesor ?></b> con correo <b><?php echo $correoPrincipal ?></b> generó un rechazo para la conversación <?php echo $urlPage ?> del flujo : <b><?php echo $flujo ?></b> </p>
							<?php else: ?>
								<p style="color:#6f6f6f;">No se aprobó tu rechazo del flujo: : <b><?php echo $flujo ?></b> </p>
							<?php endif ?>
						...
						<td style="width:500px;">
							<div style="background-color: #f9f9f9; padding: 20px 40px; font-size: 16px; font-style: italic;">
								...
								<?php if ($reject != 1): ?>	
									...
									<br>	
									<p>
										<img dataimg="https://crm.kebco.co/img/chat_images/<?php echo $ruta ?>" dataname="Rechazo" src="https://crm.kebco.co/img/chat_images/<?php echo $ruta ?>" width="400px" height="400px" class="imgmin-product">
									</p>			
								<?php endif ?>			
							</div>
						</td>
