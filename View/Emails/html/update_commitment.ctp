...
<html lang="es">
<head>
	<title>Compromiso completado</title>
				...
				<table style="width: 600px; background-color:#ffffff; color:#111E2D; display:block; margin: 0 auto; border-collapse: collapse; font-family: Helvetica, Arial, Sans-Serif;">
					<tr align="center">
						...
						<td style="width:500px;">
							...
							<p style="color:#6f6f6f;">se completó un compromiso que asignaste al usuario <?php echo $user ?></p>
						</td>
						<td style="width:50px;"></td>
					</tr>
				</table>
				...
				<table style="width: 600px; background-color:#ffffff; color:#111E2D; display:block; margin: 0 auto; border-collapse: collapse; font-family: Helvetica, Arial, Sans-Serif;">
					<tr align="center">
						<td style="width:600px;">
							...
							<p style="color:#031730;">Nombre: <b><?php echo $data["name"] ?></b></p>
							<p style="color:#031730;">Descripción: <b><?php echo $data["description"] ?></b></p>
							<p style="color:#031730;">Fecha límite: <b><?php echo $data["deadline"] ?></b></p>
						</td>
					</tr>  
				</table>
				...
				<table border="0" align="center" cellpadding="0" cellspacing="0" class="mbtn20 mtop10" cellmargin="0">
					<tr>
						...
						<td width="150" height="30" bgcolor="#031730" align="center">
							<a href="<?php echo Router::url('/', true).'commitments/index/'.md5(microtime()) ?>" style="color:#ffffff; text-decoration:none;">
