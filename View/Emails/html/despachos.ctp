			...
			<tr>
				<td>
							...
							<td style="width:500px;">
								...
								<h2>
									<b style="color:#004598;">
										Hola,
										<p align="justify">El asesor <?php echo $nameAsesor ?>, 
											ha generado una solicitud de <?php echo !isset($actualizar) ? 'despacho y/o' : '' ?> facturación para la Orden de pedido # <b> <?php echo $order_num ?> </b> relacionada al flujo <?php echo $flujo ?> 
										</b> 
									</p>
									<p align="justify">Por favor revísala, y gestíonala.</p>
								<br>
								<br>
							</td>
					...
					<table border="0" align="center" cellpadding="0" cellspacing="0" class="mbtn20 mtop10" cellmargin="0">
						<tr>
							<td width="225"></td>
							<td width="360" height="30"  align="center">
