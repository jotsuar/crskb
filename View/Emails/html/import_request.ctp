					...
					<table style="width: 600px; background-color:#ffffff; color:#111E2D; display:block; margin: 0 auto; border-collapse: collapse; font-family: Helvetica, Arial, Sans-Serif;">
						<tr>
							...
							<td style="width:500px;">
								...
								<p align="justify">El  (la) asesor (a) <b style="color:#004598;"> <?php echo $nombreAsesor ?> </b>, ha generado una solicitud de importación para el flujo con el ID <b style="color:#004598;"> <?php echo $code_import ?> </b> para el cliente  <u> <?php echo $nombreCliente ?> </u> con el (los) siguiente (s) productos.</p>
						...
						<table style="width: 600px; background-color:#ffffff; color:#111E2D; display:block; margin: 0 auto; border-collapse: collapse; font-family: Helvetica, Arial, Sans-Serif;">
							<tr>
								...
								<td colspan="2">
									...
									<p>Fabricante: <b><?php echo $value['Product']['brand'] ?></b> / N. Parte: <b><?php echo $value['Product']['part_number'] ?></b> / Precio de venta <b><?php echo number_format((int)$value['Product']['list_price_usd']) ?></b></p>
								</td>
