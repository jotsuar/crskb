					...
					<table style="width: 600px; background-color:#ffffff; color:#111E2D; display:block; margin: 0 auto; border-collapse: collapse; font-family: Helvetica, Arial, Sans-Serif;">
						<tr>
							...
							<td style="width:500px;">
								...
								<p align="justify">El  (la) asesor (a) <b style="color:#004598;"> <?php echo $usuario ?> </b>, ha solicitado un cambio de costo por el siguiente motivo:  <b style="color:#004598;"> <?php echo $razon ?> </b>, para el siguiente producto:</p>
					...
					<table style="width: 600px; background-color:#ffffff; color:#111E2D; display:block; margin: 0 auto; border-collapse: collapse; font-family: Helvetica, Arial, Sans-Serif;">
						<tr>
							...
							<td colspan="2">
								...
								<p>Fabricante: <b><?php echo $product['brand'] ?></b> / N. Parte: <b><?php echo $product['part_number'] ?></b> <br> Costo actual USD: <b><?php echo $product['purchase_price_usd'] ?></b>
								<br> Costo actual COP: <b><?php echo $product['purchase_price_cop'] ?></b>
								</p>
							</td>
