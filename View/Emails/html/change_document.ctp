				...
				<table style="width: 600px; background-color:#ffffff; color:#111E2D; display:block; margin: 0 auto; border-collapse: collapse; font-family: Helvetica, Arial, Sans-Serif;">
					<tr align="center">
						...
						<td style="width:500px;">
							...
							<p>Se ha hecho un cambio en la factura <b><?php echo $factura ?></b> por el concepto de: <b><?php echo $concepto; ?></b>.</p>
							<?php if (in_array($estado, [2,3])): ?>
								<p>
									<br>
									Se ha enviado el siguiente mensaje por parte de gerencía.
								</p>
