					...
					<tr align="center">
						...
						<td style="width:500px;">
							...
							<h2><b style="color:#031730; text-transform: capitalize;">
								<?php if (!isset($margen)): ?>
									Hola, se ha subido una nueva factura con diferencias en productos o valores, por favor revisa en el panel.
								<?php else: ?>
									Hola, se ha registrado una factura nueva con margen de <?php echo $margen_val ?> para el flujo <b><?php echo $flujo ?></b>								
								<?php endif ?>
							</b></h2>
				...
				<table border="0" align="center" cellpadding="0" cellspacing="0" class="mbtn20 mtop10" cellmargin="0">
					<tr>
						...
						<td width="180" height="30"  align="center">
							<?php if (!isset($margen)): ?>
								<a href="<?php echo Router::url("/",true)."prospectiveUsers/facturas_bloqueadas"?>" style="color:#ffffff; text-decoration:none;">
									<img src="http://crm.kebco.co/img/verenflujos.jpg">
								</a>
							<?php else: ?>
								<a href="<?php echo Router::url("/",true)."shippings/index?state=&user_id=&flujo_id=".$flujo."&cliente_id=&conveyor=&guia=&request_type=&fechas=&fechaIni=".date("Y-m-d",strtotime('-1 day'))."&fechaEnd=".date("Y-m-d")?>" style="color:#ffffff; text-decoration:none;">
									<img src="http://crm.kebco.co/img/verenflujos.jpg">
								</a>						
							<?php endif ?>
						</td>
