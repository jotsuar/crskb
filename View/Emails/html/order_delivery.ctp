					...
					<tr align="center">
						...
						<td style="width:500px;">
							...
							<?php if ($transportadora == "Entrega en Oficina"): ?>
								<p style="color:#6f6f6f;">Queremos informarte que hemos entregado tu pedido comprado en KEBCO S.A.S. en nuestra tienda</p>
							<?php else: ?>
								<p style="color:#6f6f6f;">Queremos informarte que hemos enviado tu pedido comprado en KEBCO S.A.S.</p>
							<?php endif ?>
						</td>
						<td style="width:50px;"></td>
					</tr>
