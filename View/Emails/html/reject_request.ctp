					...
					<table style="width: 600px; background-color:#ffffff; color:#111E2D; display:block; margin: 0 auto; border-collapse: collapse; font-family: Helvetica, Arial, Sans-Serif;">
						<tr>
							...
							<td style="width:500px;">
								...
								<p align="justify">El  (la) asesor (a) <b style="color:#004598;"> <?php echo $nombreAsesor ?> </b>, ha eliminado una solicitud de importación para la marca:  <b style="color:#004598;"> <?php echo $brand ?> </b>, <?php if (!is_null($prospective)) { echo ' para el flujo: <b style="color:#004598;">'. $prospective."</b>"; } ?>, por el motivo: <?php echo $motive ?>. Para el (los) siguiente (s) productos:</p>
					...
					<table border="0" align="center" cellpadding="0" cellspacing="0" class="mbtn20 mtop10" cellmargin="0">
						<tr>
							...
							<td width="150" height="30"  align="center">
								<a href="<?php echo Router::url('/', true).'ProspectiveUsers/index' ?>" style="color:#ffffff; text-decoration:none;">
