				...
				<table style="width: 600px; background-color:#ffffff; color:#111E2D; display:block; margin: 0 auto; border-collapse: collapse; font-family: Helvetica, Arial, Sans-Serif;">
					<tr align="center">
						...
						<td style="width:500px;">
							...
							<p style="color:#6f6f6f;">El asesor <b style="color:#031730"><?php echo $nombreAsesor ?></b> te ha solicitado que por favor verifiques un pago en abono que se realizó</p>
						</td>
						<td style="width:50px;"></td>
					</tr>
				</table>
				...
				<table style="width: 600px; background-color:#ffffff; color:#111E2D; display:block; margin: 0 auto; border-collapse: collapse; font-family: Helvetica, Arial, Sans-Serif;">
					<tr align="center">
						...
						<td style="width:500px;">
							...
							<p style="color:#6f6f6f;">Para verificar y aprobar el pago por favor has clic en el siguiente enlace</p>
						</td>
						<td style="width:50px;"></td>
					</tr>
				</table>
