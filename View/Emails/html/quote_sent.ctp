		...
		<tr>
			<td>
				<table style="width: 600px;  display:block; margin: 0 auto; border-collapse: collapse; font-family: Helvetica, Arial, Sans-Serif;">
					<tr>
						<td>
							<img src="http://crm.kebco.co/img/cotizacion-recibida2.png">
						</td>
					</tr>
				</table>
			</td>
			...
			<td>
				<table style="width: 600px; background-color:#ffffff; color:#111E2D; display:block; margin: 0 auto; border-collapse: collapse; font-family: Helvetica, Arial, Sans-Serif;">
					<tr align="center">
						...
						<td style="width:500px;">
							...
							<p style="color:#6f6f6f;">El asesor <b style="color:#031730"><?php echo $this->Utilities->data_null(h($nameAsesor)) ?></b> ha enviado la cotización que solicitaste a través de KEBCO S.A.S.</p>
						</td>
						<td style="width:50px;"></td>
					</tr>
				</table>
				...
				<table style="width: 600px; background-color:#ffffff; color:#111E2D; display:block; margin: 0 auto; border-collapse: collapse; font-family: Helvetica, Arial, Sans-Serif;">
					<tr align="center">
						<td style="width:50px;"></td>
						<td style="width:500px;">
							<p style="color:#6f6f6f;">Por favor revisa el archivo adjunto para verificar la cotización de tu requerimiento, en caso que no te hubiera llegado el archivo accede al enlace</p>
						</td>
						<td style="width:50px;"></td>
					</tr>
				</table>
				...
				<table border="0" align="center" cellpadding="0" cellspacing="0" class="mbtn20 mtop10" cellmargin="0">
					<tr>
						...
						<td width="180" height="30"  align="center">
							<a href="<?php echo Router::url('/', true).$ruta ?>" style="text-decoration: none;background: #004990;padding: 10px;  border-radius: 11px; color: #fff;">
								VER COTIZACIÓN
							</a>
						</td>
						<td width="225"></td>
					...
					<tr>
						...
						<td width="150" height="30" align="center">
							<a href="<?php echo Router::url('/', true).$ruta ?>" style="color:#ffffff; text-decoration:none;">
								<img src="<?php echo Router::url('/', true)."Quotations/show_image/".$this->Utilities->encryptString($quotationID); ?>">
							</a>
						</td>
						<td width="235"></td>
					</tr>
