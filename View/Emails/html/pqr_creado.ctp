					...
					<table style="width: 600px; background-color:#ffffff; color:#111E2D; display:block; margin: 0 auto; border-collapse: collapse; font-family: Helvetica, Arial, Sans-Serif;">
						<tr>
							...
							<td style="width:500px;">
								...
								<?php if ($type == 1): ?>
									<p align="justify">Se ha creado con éxito el PQRS, muy pronto nuestro equipo de <b>Kebco - Almacendelpintor.com</b> te contactará.</p>
								<?php else: ?>
									<p align="justify">Se ha gestionado con éxito el PQRS, muy pronto nuestro equipo de <b>Kebco - Almacendelpintor.com</b> te contactará.</p>
								<?php endif ?>
								<br>
								<br>
								<p>Podras dar seguimiento a este PQRS haciendo clic en el siguiente enlace.</p>
							</td>
					...
					<table border="0" align="center" cellpadding="0" cellspacing="0" class="mbtn20 mtop10" cellmargin="0">
						<tr>
							...
							<td width="180" height="30"  align="center">
								<a href="<?php echo Router::url('/', true) ?>gestion-pqrs/<?php echo $this->Utilities->encryptString($id) ?>" style="text-decoration: none;background: #004990;padding: 10px;  border-radius: 11px; color: #fff;">
									GESTIONAR PQRS
								</a>
							</td>
							<td width="225"></td>
