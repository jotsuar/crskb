						...
						<tr>
							...
							<td style="width:500px;">
								...
								<h2><b style="color:#004598;">
									Hola,
									<p align="justify">El asesor <?php echo $nameAsesor ?>,  te ha enviado la Orden de pedido # <b> <?php echo $order_num ?> </b> relacionada a la cotización enviada con identificador <b> <?php echo $this->Utilities->getQuotationId($flujo,true)["FlowStage"]["codigoQuotation"] ?> </b> </p>
									<p align="justify">Por favor revísala, ya que requerimos tu aprobación de la misma para poder proceder.</p>
								<br>
								<br>
							</td>
					...
					<table border="0" align="center" cellpadding="0" cellspacing="0" class="mbtn20 mtop10" cellmargin="0">
						<tr>
							...
							<td width="180" height="30"  align="center">
								<a href="<?php echo Router::url('/', true) ?>orders/view/<?php echo $this->Utilities->encryptString($id) ?>/<?php echo $this->Utilities->encryptString("clientLink") ?>" style="text-decoration: none;background: #004990;padding: 10px;  border-radius: 11px; color: #fff;">
									VER ORDEN DE PEDIDO
								</a>
							</td>
							<td width="225"></td>
