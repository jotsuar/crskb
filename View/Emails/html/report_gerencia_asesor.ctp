...
<body style="background-color:#f8f8f8;">
	<table align="center" style="width: 600px; display:block; margin: 0 auto; border-collapse: collapse; font-family: Helvetica, Arial, Sans-Serif;background-color:#ffffff;">
		...
		<tr>
			<td>
				<table style=" text-align: center; width: 600px; background-color:#ffffff; color:#111E2D; display:block; margin: 0 auto; border-collapse: collapse; font-family: Helvetica, Arial, Sans-Serif;">
					<thead>
						<tr>
							<th>Cliente</th>
							<th>Requerimiento</th>
					...
					<tbody>
						<?php foreach ($flujos as $etapas): ?>
							<?php foreach ($etapas as $filas): ?>
								<td><?php echo $this->Utilities->data_null(h($filas['AtentionTime']['cliente'])) ?></td>
								<td><?php echo $this->Utilities->data_null(h($filas['AtentionTime']['requerimiento'])) ?></td>
								<td><?php echo $this->Utilities->data_null(h($filas['AtentionTime']['tiempo_limite'])) ?></td>
								<td><?php echo $this->Utilities->data_null(h($filas['AtentionTime']['tiempo_atendido'])) ?></td>
								<td><?php echo $this->Utilities->data_null(h($filas['AtentionTime']['etapa'])) ?></td>
							<?php endforeach ?>
						<?php endforeach; ?>
					</tbody>
				</table>
				...
				<table border="0" align="center" cellpadding="0" cellspacing="0" class="mbtn20 mtop10" cellmargin="0">
					<tr>
						<td width="225"></td>
						<td width="150" height="30" bgcolor="#031730" align="center"> <a href="<?php echo Router::url('/', true)?>users/login" style="color:#ffffff; text-decoration:none;"><span style="font-family:arial; font-size:14px;color:#ffffff;">IR A KEBCO CRM</span></a></td>
						<td width="225"></td>
				...
				<table style="width: 600px; background-color:#ffffff; color:#111E2D; display:block; margin: 0 auto; border-collapse: collapse; font-family: Helvetica, Arial, Sans-Serif;">
					<tr align="center">
						...
						<td style="width:500px;">
							<hr>
							<p style="color:#6f6f6f;"><span>KEBCO &copy; - AlmacenDelPintor.com </span></p><br>
						</td>
						<td style="width:50px;"></td>
					</tr>
				</table>
