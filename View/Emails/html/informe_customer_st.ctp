...
<html lang="es">
	<head>
		<title>Te informamos de una anomalía en la orden de servicio- KEBCO AlmacenDelPintor.com</title>
					...
					<table style="width: 600px; background-color:#ffffff; color:#111E2D; display:block; margin: 0 auto; border-collapse: collapse; font-family: Helvetica, Arial, Sans-Serif;">
						<tr>
							...
							<td style="width:500px;">
								...
								<p align="justify">Desde el área de Servicio Técnico de Kebco, te informamos que el servicio <b><?php echo $technicalServices["TechnicalService"]["code"] ?></b> a cargo de el (la) asesor (a) <b style="color:#004598;"> <?php echo $datos_asesor["User"]["name"] ?> </b>, cuenta con una anomalía descrita a continuación: <br> <br> <?php echo $texto ?>. <br></p>
