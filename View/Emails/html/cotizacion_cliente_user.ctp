					...
					<tr align="center">
						...
						<td style="width:500px;">
							...
							<p style="color:#6f6f6f;">
								El asesor <?php echo $usuario ?> esta cotizando el cliente <?php echo $cliente ?>, al cual le cotizaste recientemente
							</p>
						</td>
				...
				<table border="0" align="center" cellpadding="0" cellspacing="0" class="mbtn20 mtop10" cellmargin="0">
					<tr>
						...
						<td width="150" height="30"  align="center">
							<a href="<?php echo Router::url('/', true)."prospective_users?q=".$flujo ?>" style="color:#ffffff; text-decoration:none;">
