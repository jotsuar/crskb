			...
			<td>
				<table style="width: 600px; background-color:#ffffff; color:#111E2D; display:block; margin: 0 auto; border-collapse: collapse; font-family: Helvetica, Arial, Sans-Serif;">
					<tr align="center">
						...
						<td style="width:500px;">
							...
							<p style="color:#6f6f6f;">Has sido registrado en KEBCO S.A.S.</p>
						</td>
						<td style="width:50px;"></td>
					</tr>
				</table>
				...
				<table style="width: 600px; background-color:#ffffff; color:#111E2D; display:block; margin: 0 auto; border-collapse: collapse; font-family: Helvetica, Arial, Sans-Serif;">
					<tr align="center">
						<td style="width:600px;">
							<p style="color:#6f6f6f;">Tu usuario y contraseña son los siguientes:</p>
							<p style="color:#031730;">Usuario: <b><?php echo $this->Utilities->data_null(h($email)) ?></b></p>
							<?php if (!isset($externo)): ?>
								<p style="color:#031730;">Contraseña: <b><?php echo $this->Utilities->data_null(h($password)) ?></b></p>	
							<?php else: ?>
								<p style="color:#031730;">Contraseña: <b>La que usaste al momento del registro</b></p>	
							<?php endif ?>
						</td>
					</tr>  
				</table>
				...
				<table style="width: 600px; background-color:#ffffff; color:#111E2D; display:block; margin: 0 auto; border-collapse: collapse; font-family: Helvetica, Arial, Sans-Serif;">
					<tr align="center">
						<td style="width:50px;"></td>
						<td style="width:500px;">
							<p style="color:#6f6f6f;">Por favor recuerda cambiar la contraseña para proteger tu cuenta</p>
						</td>
						<td style="width:50px;"></td>
					</tr>
				</table>
