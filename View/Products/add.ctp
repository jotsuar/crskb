...
<div class="container p-0">
	<div class="col-md-12 p-0">
		...
		<div class="blockwhite spacebtn20">
			<h2 class="titleviewer">Crear producto</h2>
		</div>			
		<div class="products form blockwhite">
			<ul class="nav nav-tabs" id="myTab" role="tablist">
			  ...
			  <li class="nav-item">
			    <a class="nav-link disabled" id="profile-tab" data-toggle="tab" href="#profile" role="tab" aria-controls="profile" aria-selected="false">Imágenes y documentos</a>
			  </li>
			</ul>
			<?php echo $this->Form->create('Product',array('enctype'=>"multipart/form-data",'data-parsley-validate','id' => 'form_product')); ?>
				<div class="row">
					<div class="col-6">
					...
					<div class="col-6">
						...
						<?php echo $this->Form->input('part_number',array('label' => 'Número de parte','placeholder' => 'Ingresa la referencia del equipo que da el fabricante','class' => "flexdatalist", "list" => "references","data-min-length" => 1));?>
					...
					<div class="col-md-12 col-sm-12">
						<div class="row">
							<div class="col-md-3">
								<div class="form-group categoriasData_1_<?php echo $key ?> catDivs">
							...
							<div class="col-md-3">
								<div class="form-group categoriasData_2_<?php echo $key ?> catDivs">
									<label for="categoryData">Categoría Grupo 2</label>
									<select name="data[Product][category_2]" id="category_2" required>
										<option value="">Seleccionar</option>
									</select>
								</div>
							</div>
							<div class="col-md-3">
								<div class="form-group categoriasData_3_<?php echo $key ?> catDivs">
									<label for="categoryData">Categoría Grupo 3</label>
									<select name="data[Product][category_3]" id="category_3" required>
										<option value="">Seleccionar</option>
									</select>
								</div>
							</div>
							<div class="col-md-3">
								<div class="form-group mb-2 categoriasData_4_<?php echo $key ?> catDivs">
									<label for="categoryData">Categoría Grupo 4</label>
									<select name="data[Product][category_4]" id="category_4" required>
										<option value="">Seleccionar</option>
									</select>
								</div>
							</div>
					...
					<div class="col-md-3">
						<?php echo $this->Form->input('brand',array('label' => 'Marca:', 'options' => $marca,"required")); ?>
					</div>
					<div class="col-md-3">
					...
					<div class="col-md-3" <?php echo in_array(AuthComponent::user("role"), ["Gerente General","Logística"] ) ? '' : 'display:none' ?>>
						<?php echo $this->Form->input('fixed_price',array('label' => 'Precio fijo de venta con inventario','placeholder' => '¿Cuánto cuesta el producto?','type' => "text" ,"div" => "input","value" => 0)); ?>
						
					</div>
					<div class="col-md-3" <?php echo in_array(AuthComponent::user("role"), ["Gerente General","Logística"] ) ? '' : 'display:none' ?>>
						<?php echo $this->Form->input('fixed_cop',array('label' => 'Precio fijo de venta sin inventario','placeholder' => '¿Cuánto cuesta el producto?','type' => "text" ,"div" => "input","value" => 0)); ?>
						
					</div>
					<div class="col-md-3" <?php echo in_array(AuthComponent::user("role"), ["Gerente General","Logística"] ) ? '' : 'display:none' ?>>
						<?php echo $this->Form->input('fixed_usd',array('label' => 'Precio fijo de venta USD','placeholder' => '¿Cuánto cuesta el producto?','type' => "text" ,"div" => "input","value" => 0, "step" => '0.01')); ?>
					...
					<?php 
						...
						if (in_array(AuthComponent::user('role'), $rolesPriceImport) || AuthComponent::user("email") == "ventas2@almacendelpintor.com") {
							...
							echo $this->Form->input('min_stock',array('type' => 'number','label' => 'Stock mínimo de reposición',"value" => 0, "type" => "hidden"));
							echo $this->Form->input('reorder',array('type' => 'number','label' => 'Cantidad para reordenar el producto',"value" => 0 ,"type" => "hidden"));
							echo $this->Form->input('max_cost',array('type' => 'number','label' => 'Stock máximo de reposición',"value" => 0, "type" => "hidden"));	
						}
