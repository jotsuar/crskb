...
<div class="col-md-12">
	...
	<div class="blockwhite spacebtn20">
		<h2 class="titleviewer">Crear marca</h2>
	</div>	
	<div class="blockwhite spacebtn20">
		<div class="brands form">
		<?php echo $this->Form->create('Brand',array('data-parsley-validate'=>true,)); ?>
			<?php
				...
				echo $this->Form->input('copy_emails',array("label" => "Correo eléctronicos adicionales", $readonly, "type" => "text"));
				echo $this->Form->input('contact_name',array("label" => "Nombre contacto","required"));
				echo $this->Form->input('min_price_importer',array("label" => "Costo mínimo de importación","type" => "text","required"));
