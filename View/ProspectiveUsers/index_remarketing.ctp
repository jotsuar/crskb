				...
				<div class="row">			
					<nav class="navbar navbar-expand-lg navbar-light bg-filter p-1">
						<div class="collapse navbar-collapse" id="navbarTogglerDemo01">
							...
							<?php if (AuthComponent::user("role") == "Gerente General" || AuthComponent::user("role") == "Servicio al Cliente" || AuthComponent::user("role") == "Contabilidad"): ?>
								<a href="<?php echo $this->Html->url(array('controller'=>'ProspectiveUsers','action'=>'index_externals')) ?>">Flujos Externos</a>
								<b><a href="<?php echo $this->Html->url(array('controller'=>'ProspectiveUsers','action'=>'index_remarketing')) ?>">Flujos remarketing</a></b>
							<?php endif ?>
						</div>
					...
					<?php foreach ($prospectiveUsers as $prospectiveUser): ?>
						...
						<?php endif; ?>
							...
							<?php endif ?>
									...
									<?php endif ?>
									<?php if( AuthComponent::user('role') == Configure::read('variables.roles_usuarios.Contabilidad') || AuthComponent::user('role') == Configure::read('variables.roles_usuarios.Gerente General') || AuthComponent::user('role') == Configure::read('variables.roles_usuarios.Asesor Comercial')  ): ?>
										<div class="linealign">
							...
							<div class="row bs-wizard" >
								...
								<?php if (!is_null($prospectiveUser["ProspectiveUser"]["clients_natural_id"]) || $prospectiveUser["ProspectiveUser"]["contacs_users_id"] > 0): ?>
									...
									<div class="col-md-2 bs-wizard-step <?php echo $this->Utilities->validate_state_negociado($prospectiveUser['ProspectiveUser']['id'],$prospectiveUser['ProspectiveUser']['state_flow']); ?>">
										<div class="progress"><div class="progress-bar"></div></div>
										<span class="bs-wizard-dot state_negociado" data-uid="<?php echo $prospectiveUser['ProspectiveUser']['id'] ?>" data-id="<?php echo $this->Utilities->encryptString($prospectiveUser['ProspectiveUser']['id']) ?>" data-state="<?php echo $prospectiveUser['ProspectiveUser']['state_flow'] ?>"></span>
