...
<!-- 	<div class=" widget-panel widget-style-2 bg-morado big">
         <i class="fa fa-1x flaticon-tourism"></i>
	...
	<div class="blockwhite-import spacebtn20">
		<div class="row">
			...
			<div class="col-md-2">
				...
				<a href="javascript:void(0)" class="btn btn-info pull-right viewInventory" data-id="<?php echo 0 ?>">
					<i class="fa fa-eye vtc"></i> Ver inventario de alta rotación
				</a>
				<?php endif ?>
			</div>
			<div class="col-md-6">
			...
			<table class="table-striped tableCotizacionesEnviadas table-bordered">
				<thead class="titlestab">
					<tr>
						...
						<th><?php echo $this->Paginator->sort('Import.purchase_order', 'Número de orden'); ?></th>
						...
						<tr>
							...
							<td class="text-center">
								...
								<?php if (AuthComponent::user("role") == Configure::read('variables.roles_usuarios.Gerente General')): ?>								
											...
											<?php endif ?>
											<?php endif ?>
									<!-- <a href="#" data-uid="<?php echo $value['Import']['id'] ?>" class="btn_rechazar btn btn-outline-danger" data-toggle="tooltip"  title="Rechazar"><i class="fa fa-times vtc"></i></a> -->
								<?php endif ?>
							</td>
						</tr>
					<?php endforeach ?>
