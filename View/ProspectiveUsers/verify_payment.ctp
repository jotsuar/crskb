	...
	<div class=" blockwhite spacebtn20">
		<div class="row ">
			<div class="col-md-12 text-center">
				<h1 class="nameview">VERIFICACIÓN DE PAGOS POR TRANSFERENCIA O CONSIGNACIÓN</h1>
			</div>
		</div>
	</div>
			...
			<table cellpadding="0" cellspacing="0" class='table-striped datosPendientesDespacho table-bordered'>
				<thead>
					<tr>
						...
						<th class="size1">Cotización</th>
						<th>Foto</th>
						<th>Tipo <span class="nolaptop">de pago</span></th>
						<th>Cliente</th>
						<th>Acciones</th>
					</tr>
				</thead>
				<tbody>
					<?php foreach ($flujosVerify as $value): ?>
						<tr>
							...
							<td>
								<a href="javascript:void(0)" class="confirm_payment_flujo btn btn-success text-white <?php echo $value["FlowStage"]["payment"] == 'Datáfono' ? 'datafonoClass' : '' ?>" data-toggle="tooltip" title="Confirmar pago" data-uid="<?php echo $value['FlowStage']['id'] ?>" data-discount="<?php echo $value["FlowStage"]["payment"] == 'Datáfono' ?  $value['ProspectiveUser']['discount_datafono'] : '0' ?>" data-user_id="<?php echo $value['ProspectiveUser']['user_id'] ?>" data-flujo_id="<?php echo $value['ProspectiveUser']['id'] ?>"><i class="fa fa-check vtc"></i></a>
