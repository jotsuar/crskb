	...
	<div class=" blockwhite spacebtn20">
		<div class="row ">
			<div class="col-md-12 text-center">
				<h1 class="nameview">INFORMES DE TESORERÍA <?php echo AuthComponent::user("role") != "Asesor Externo" ? " - Asesores Externos" : "" ?></h1>
			</div>
		</div>
	</div>
...
<div class="col-md-12">
	...
	<div class="blockwhite spacebtn20">
		<div class="row">
			<div class="col-md-5">
				<h1 class="nameview2">INFORME DE COMISIONES GANADAS POR GESTIONAR PAGO</h1>
				<span class="subname">Informe de comisiones teniendo en cuenta las facturas y los recibos de caja de pagos recibidos</span>
			</div>
			<div class="col-md-7">
				<div class="row">
					<?php echo $this->Form->create('ProspectiveUser',array('class' => 'form w-100')); ?>
						<div class="col-md-12">
							<div class="row">
								...
								<div class="col-md-2 spacetop d-none">
				...
				<tbody>						
					...
					<?php else: ?>
						...
						<tr>
							...
							<td colspan="3"><h2>$<?php echo number_format($totalPagar,0,".",",") ?></h2> <br>
								<a href="" class="btn btn-warning getCuentaCobro">
...
<div class="modal fade" id="modalCuentaCobro" tabindex="-1" role="dialog" aria-hidden="true" data-backdrop="static" data-keyboard="false">
  <div class="modal-dialog modal-lg3" role="document">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h2 class="modal-title"> Gestión cuenta de cobro </h2>
      </div>
      <div class="modal-body" id="bodyCuentaCobro">
      </div>
      <div class="modal-footer">
        <a class="cancelmodal" data-dismiss="modal">Cancelar</a>
      </div>      
