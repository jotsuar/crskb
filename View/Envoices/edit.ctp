...
<?php echo $this->Form->create('Envoice'); ?>
	<fieldset>
		<legend><?php echo __('Edit Envoice'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('Envoice.id')), array('confirm' => __('Are you sure you want to delete # %s?', $this->Form->value('Envoice.id')))); ?></li>
