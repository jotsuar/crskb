	...
	<div class="row spacetopbottom">
		...
		<div class="col-md-9">
			<div class="dataproductview2">
				...
				<div>
					<?php echo $this->element("products_block",["producto" => $producto["Product"], "inventario_wo" => $partsData[$producto["Product"]["part_number"]] ,"reserva" => isset($partsData["Reserva"][$producto["Product"]["part_number"]]) ? $partsData["Reserva"][$producto["Product"]["part_number"]] : null ]) ?>
				</div>		
			</div>
		</div>
	</div>
